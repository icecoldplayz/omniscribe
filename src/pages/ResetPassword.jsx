...
// NOTE: Supabase's password reset flow works differently than Base44's.
// The link Supabase emails contains a session token in the URL fragment;
// the Supabase client auto-detects it and fires a PASSWORD_RECOVERY event,
// establishing a temporary logged-in session. We just check for that
// session here and call updateUser() — there's no separate "resetToken"
// to pass around ourselves.
